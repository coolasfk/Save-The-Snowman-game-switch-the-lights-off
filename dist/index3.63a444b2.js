...
var mouseLeaveEvent = function mouseLeaveEvent(e) {
  ...
  setTimeout(function () {
    e.target.style.fill = "#d9f4f1";
    e.target.style.opacity = 0.1;
    // e.target.classList.toggle("active");
  }, "1000");
};
var addHoverListeners = function addHoverListeners() {
  console.log("start dodawania hoverów");
...
directionsArrows.forEach(function (arrow) {
  arrow.addEventListener("click", function () {
    ...
    directionsArrows.forEach(function (el) {
      return el.style.opacity = 0.1;
    });
    arrow.style.opacity = 1;
    arrow.style.fill = "#d9f4f1";
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index3.js"], null)
